...
# mme as an example
export HF_HOME="/data/dlf/code/Field-Fidelity/.cache/huggingface"
...
accelerate launch --num_processes=8 --main_process_port=12346 -m lmms_eval \
    --model qwen2_5_vl \
    --model_args=pretrained=/data/share/hub/models/Qwen/Qwen2___5-VL-7B-Instruct,max_pixels=12845056,attn_implementation=flash_attention_2,interleave_visuals=False \
    --tasks pope \
    --batch_size 1